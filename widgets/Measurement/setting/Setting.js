...
require({
	cache: {
		...
		"*now": function(f) {
			f(['dojo/i18n!*preload*widgets/Measurement/setting/nls/Setting*["ar","bg","bs","ca","cs","da","de","en","el","es","et","fi","fr","he","hr","hu","id","it","ja","ko","lt","lv","nb","nl","pl","pt-br","pt-pt","ro","ru","sk","sl","sr","sv","th","tr","zh-cn","uk","vi","zh-hk","zh-tw","ROOT"]'])
		},
		"*noref": 1
	}
});
define("dojo/_base/declare dojo/_base/lang dojo/Deferred dojo/_base/html dijit/_WidgetsInTemplateMixin jimu/BaseWidgetSetting jimu/portalUtils esri/units dojo/on dijit/Tooltip dojo/mouse jimu/dijit/CheckBox dijit/form/Select".split(" "), function(f, c, k, l, m, n, p, d, g, e, q, r) {
	return f([n, m], {
		baseClass: "jimu-widget-measurement-setting",
		startup: function() {
			this.inherited(arguments);
			this.config.measurement || (this.config.measurement = {});
			...
			this.cbxOperationalLayer = new r({
				label: this.nls.operationalLayer,
				style: "margin-top:10px;margin-left:2px;"
			});
			l.addClass(this.cbxOperationalLayer.domNode, "tip");
			this.cbxOperationalLayer.placeAt(this.domNode);
			this.setConfig(this.config)
		},
		_processConfig: function(a) {
			var b = new k;
			a.defaultLengthUnit && a.defaultAreaUnit ? b.resolve(a) : p.getUnits(this.appConfig.portalUrl).then(c.hitch(this, function(h) {
				a.defaultAreaUnit = "english" ===
					h ? d.SQUARE_MILES : d.SQUARE_KILOMETERS;
				a.defaultLengthUnit = "english" === h ? d.MILES : d.KILOMETERS;
				b.resolve(a)
			}));
			return b.promise
		},
		setConfig: function(a) {
			this.config = a;
			this._processConfig(a).then(c.hitch(this, function(b) {
				b.measurement.defaultAreaUnit ? this.selectAreaUnit.set("value", b.measurement.defaultAreaUnit) : this.selectAreaUnit.set("value", "esriAcres");
				b.measurement.defaultLengthUnit ? this.selectLengthUnit.set("value", b.measurement.defaultLengthUnit) : this.selectLengthUnit.set("value", "esriMiles");
				"undefined" !==
				typeof b.showArea && !1 === b.showArea && this.showArea.setValue(!1);
				"undefined" !== typeof b.showDistance && !1 === b.showDistance && this.showDistance.setValue(!1);
				"undefined" !== typeof b.showLocation && !1 === b.showLocation && this.showLocation.setValue(!1);
				b.isOperationalLayer ? this.cbxOperationalLayer.setValue(!0) : this.cbxOperationalLayer.setValue(!1)
			}))
		},
		getConfig: function() {
		...
		_initShowToolItem: function(a) {
			a && (a.setValue(!0), this._showToolsItems.push(a), this.own(g(a, "change", c.hitch(this, this._onShowToolItemsChange, a))))
		},
		_onShowToolItemsChange: function(a) {
			a && !1 === a.checked && this._isItemsAllHide() && (a.check(), e.hide(), e.show(this.nls.allHidedTips, a.domNode), this.own(g.once(a.domNode,
				q.leave, c.hitch(this, function() {
					e.hide(a.domNode)
				}))))
		},
		_isItemsAllHide: function() {
			for (var a = 0, b = this._showToolsItems.length; a < b; a++)
				if (!0 === this._showToolsItems[a].checked) return !1;
			return !0
		}
	})
});