...
define([
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    _initLayerIndexs: function() {
      ...
      console.log(this._layerIndexs);
      delete this._layerIndexs['Segmentos Viales Fiscalías'];
      delete this._layerIndexs["Puentes Vehiculares Fiscalias"];
      delete this._layerIndexs["Puentes Peatonales Fiscalías"];
      delete this._layerIndexs["Calzadas"];
