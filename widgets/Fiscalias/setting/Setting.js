...
define([
  ...
  function(on, query, Deferred, declare, BaseWidgetSetting, _WidgetsInTemplateMixin, html, lang,
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      baseClass: 'jimu-widget-Fiscalias-setting',
      dijits: null,
      dijitSettings: null,
      _dataSource: null,
      ...
      _chooseDataSource: function() {
        ...
        var args = {
          dijitArgs: {
            types: DataSource.createFiscaliasTypes({
      ...
      _onChooseTemplateClick: function() {
        if (store.get('widgets_Fiscalias_notShowTemplateWarning') &&
          store.get('widgets_Fiscalias_notShowTemplateWarning') === true) {
          this._chooseTemplate().then(function(template) {
          ...
          this.own(on(checkBox, 'change', function(check) {
            if (check) {
              store.set('widgets_Fiscalias_notShowTemplateWarning', true);
            }
          }));
          var pop = new Popup({
            content: content,
